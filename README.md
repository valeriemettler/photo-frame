...
puts a street map in colour under the dots - blue water, beige land, white and
orange roads, no labels (CARTO's Voyager basemap, OpenStreetMap's standard
tiles as fallback); **Dark map** is the same map in near-black; **Plain** is
